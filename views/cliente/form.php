...
if (!isset($cliente) || !is_array($cliente)) { $cliente = []; }
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="contenedor">
    ...
    <?php if (!isset($cliente) || !is_array($cliente)) { $cliente = []; } ?>

    <form method="post" action="<?= $baseUrlCliente ?>?accion=<?= $idCliente ? 'editar&id=' . $idCliente : 'crear' ?>">
        ...
        <a href="<?= $baseUrlCliente ?>?accion=listar" class="cancelar">Cancelar</a>
