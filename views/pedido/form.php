...
if (!isset($distribuciones) || !is_array($distribuciones)) {
    $distribuciones = [];
}
>>>>>>> Stashed changes
?>
...
<nav>
    ...
    <style>
        ...
        /* Mantener el contenedor centrado como en los demás formularios */
        .contenedor {
            background: #ffffff;
            padding: 25px 35px;
            width: 420px;
            ...
            margin: 50px auto; /* centra horizontalmente y añade separación superior */
        }
...
=======
    <form method="post" action="<?= $baseUrlPedido ?>?accion=<?= $idPedido ? 'editar' : 'crear' ?><?= $idPedido ? '&id='.$idPedido : '' ?>">
>>>>>>> Stashed changes
